...
def main():
    ...
    z_vertex_root_path = f'vernier_scan_{scan_date}_mbd_vertex_z_distributions.root'
    cad_measurement_path = f'VernierScan_{scan_date}_combined.dat'
    longitudinal_fit_path = f'VernierScan_{scan_date}_COLOR_longitudinal_fit.dat'
